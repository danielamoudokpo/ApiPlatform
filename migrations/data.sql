...
-- Shops data with category_id and owner_id from User and Category tables
...
-- Hours data for Shops (reference Shop table by shop_id)
INSERT INTO Hour (start, end, day, shop_id)
VALUES (TIME('08:00:00'), TIME('18:00:00'), 1, (SELECT id FROM Shop WHERE name = 'John\'s Hair Salon' LIMIT 1)),
       (TIME('08:00:00'), TIME('18:00:00'), 2, (SELECT id FROM Shop WHERE name = 'John\'s Hair Salon' LIMIT 1)),
       (TIME('08:00:00'), TIME('18:00:00'), 3, (SELECT id FROM Shop WHERE name = 'John\'s Hair Salon' LIMIT 1)),
       (TIME('08:00:00'), TIME('18:00:00'), 4, (SELECT id FROM Shop WHERE name = 'John\'s Hair Salon' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 5, (SELECT id FROM Shop WHERE name = 'John\'s Hair Salon' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 1, (SELECT id FROM Shop WHERE name = 'Jane\'s Nail Salon' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 2, (SELECT id FROM Shop WHERE name = 'Jane\'s Nail Salon' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 3, (SELECT id FROM Shop WHERE name = 'Jane\'s Nail Salon' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 4, (SELECT id FROM Shop WHERE name = 'Jane\'s Nail Salon' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 5, (SELECT id FROM Shop WHERE name = 'Jane\'s Nail Salon' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 1, (SELECT id FROM Shop WHERE name = 'Jim\'s Massage Spa' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 2, (SELECT id FROM Shop WHERE name = 'Jim\'s Massage Spa' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 3, (SELECT id FROM Shop WHERE name = 'Jim\'s Massage Spa' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 4, (SELECT id FROM Shop WHERE name = 'Jim\'s Massage Spa' LIMIT 1)),
       (TIME('10:00:00'), TIME('20:00:00'), 5, (SELECT id FROM Shop WHERE name = 'Jim\'s Massage Spa' LIMIT 1));
